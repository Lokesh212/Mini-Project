...
public class Base_Class {
	...
	//Drop down
	public static void dropDown(WebElement element , String type, int index , String value) {
	...
	public static void screenshot(String filename) throws Throwable {
		...
		File des = new File("C:\\Users\\DELL\\eclipse-workspace\\Automation_Practice\\Screenshot\\pic.png");
